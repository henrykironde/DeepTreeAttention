...
data_module = data.TreeData(csv_file="data/raw/neon_vst_data_2021.csv", regenerate=config["regenerate"], client=client, metadata=True, comet_logger=comet_logger, debug=True)
data_module.setup()
if client:
    client.close()
